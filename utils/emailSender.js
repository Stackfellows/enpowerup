...
transporter.verify(function (error, success) {
  if (error) {
    console.error("❌ Email sender connection failed:", error.message);
    console.error(
      "Please check your EMAIL_USER and EMAIL_APP_PASSWORD in the .env file."
    );
  } else {
    console.log(
      "✅ Email sender connected successfully, ready to send emails!"
    );
  }
});
      ...
      html: `
        <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 20px auto; padding: 0; border: none; background-color: #ffffff;">
          ...
          <div style="text-align: center; background-color: #000; padding: 20px 0;">
            <img src="https://placehold.co/600x200/cccccc/333333?text=EMPOWERUP+HEADER+IMAGE" alt="EmpowerUp Header" style="max-width: 100%; height: auto; display: block; margin: 0 auto;">
          </div>
          ...
          <div style="padding: 40px; background-color: #ffffff; border: 1px solid #e0e0e0; border-top: none; border-radius: 0 0 8px 8px;">
            ...
            <p style="font-weight: bold; margin-bottom: 5px;">Your FBO's information is:</p>
            <p style="margin-bottom: 5px;">${fboName || "Samra Mehar"}</p>
            <p style="margin-bottom: 5px;">${
              fboAddress || "PAKISTAN, Abu Dhabi 52250<br>United Arab Emirates"
            }</p>
            <p style="margin-bottom: 20px;"><a href="mailto:${
              fboEmail || "samramehar007@gmail.com"
            }" style="color: #007bff; text-decoration: none;">${
        fboEmail || "samramehar007@gmail.com"
      }</a></p>

            <p style="margin-bottom: 20px;">Get started by setting password for your account. <a href="http://localhost:3000/set-password" style="color: #007bff; text-decoration: none;">Click here</a></p>

            <p style="margin-bottom: 10px;">If you have any questions or comments, please contact our Customer Support Team at <a href="mailto:customerservice-uae@foreverliving.ae" style="color: #007bff; text-decoration: none;">customerservice-uae@foreverliving.ae</a> or +971 4 520 5800.</p>
